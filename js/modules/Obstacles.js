/**
 * Gerencia a criação e renderização de obstáculos
 * Obstáculos aparecem conforme o jogador progride no jogo
 */
...
export class Obstacles {
    ...
    draw(ctx) {
        ...
        this.list.forEach(ob => {
            ctx.beginPath();
            roundRect(ctx, ob.x, ob.y, GAME_CONFIG.GRID_SIZE, GAME_CONFIG.GRID_SIZE, 5);
            ctx.fill();
            ctx.stroke();
        });
    }
